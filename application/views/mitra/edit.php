...
<div class="form-group row">
  ...
  <div class="col-8">
    <input id="nama_mitra" name="nama_mitra" placeholder="PT/CV" type="text"
      class="form-control" value="<?=$objmitra->nama?>">
  </div>
  </div>
  <div class="form-group row">
    <label for="alamat" class="col-4 col-form-label">Alamat</label> 
    <div class="col-8">
      <textarea id="alamat" name="alamat" cols="40" rows="5" 
      class="form-control"><?=$objmitra->alamat?></textarea>
    </div>
  </div>
  <div class="form-group row">
    <label for="kontak_person" class="col-4 col-form-label">Kontak Person</label> 
    <div class="col-8">
      <input id="kontak_person" name="kontak_person" type="text" 
      class="form-control" value="<?=$objmitra->kontak?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="telpon" class="col-4 col-form-label">Telpon</label> 
    <div class="col-8">
      <input id="telpon" name="telpon" placeholder="08xxx" type="text" 
    class="form-control" value="<?=$objmitra->telpon?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="email" class="col-4 col-form-label">Email</label> 
    <div class="col-8">
      <input id="email" name="email" placeholder="example@example.com" type="text" 
      class="form-control" value="<?=$objmitra->email?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="alamat_web" class="col-4 col-form-label">Alamat Web</label> 
    <div class="col-8">
      <input id="alamat_web" name="alamat_web" placeholder="www.example.com" type="text" 
      class="form-control" value="<?=$objmitra->web?>">
    </div>
  </div> 
  <div class="form-group row">
